...
def hello_world():
    ...
    pageHtml = '<h1>System Date and time Flask test</h1>' \
               ...
               '<h2> <a href= http://energyshop.online:8090> Back to Main</a> </h2>'
    return (pageHtml)
...
#    <h3> <a href= http://energyshop.online:8090/hello> Click for time</a> </h3>
@app.route('/')
def hello_home():
    pageHtml = '<h1>Main Menu</h1>' \
               '<h2><font color="red">Proof of concept</font></h2>' + \
               '<h3> <a href= http://energyshop.online:8090/hello> 1) Python DateTime FLASK test</a> </h3>' + \
               '<h3> <a href= http://energyshop.online:8090/time> 2) Click for time (sirovo)-RAW</a> </h3>' + \
